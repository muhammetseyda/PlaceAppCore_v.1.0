...
namespace PlaceApp.Migrations
{
    ...
    [Migration("20231201061703_addmodellistuser")]
    partial class addmodellistuser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlaceApp.Models.LikeUserViewModel", b =>
                {
                    ...
                    b.ToView("YourStoredProcedureName", (string)null);
                });
            ...
            modelBuilder.Entity("PlaceApp.Models.Comment", b =>
                {
                    b.HasOne("PlaceApp.Models.Users", "Users")
                        .WithMany()
            ...
            modelBuilder.Entity("PlaceApp.Models.SharePlace", b =>
                {
                    ...
                    b.HasOne("PlaceApp.Models.Users", null)
                        .WithMany("SharePlaces")
                        .HasForeignKey("UsersId");
                });
            ...
            modelBuilder.Entity("PlaceApp.Models.Users", b =>
                {
                    b.Navigation("PlaceLists");

                    b.Navigation("Places");

                    b.Navigation("SharePlaces");

                    b.Navigation("SharePlacesList");
                });
